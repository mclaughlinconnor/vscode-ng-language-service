...
npm_translate_lock(
    ...
    data = [
        ...
        "//:transform_package_json.js",

        "//:.yarn/patches/minipass-flush-npm-1.0.5-efe79d9826.patch",
        "//:.yarn/patches/minipass-sized-npm-1.0.3-306d86f432.patch",
        "//:.yarn/patches/minipass-pipeline-npm-1.2.4-5924cb077f.patch",

        "//:patches/minipass-flush.patch",
        "//:patches/minipass-pipeline.patch",
        "//:patches/minipass-sized.patch"
    ],
    patch_args = {
        "*": ["-p1"],
    },
